<template>
  ...
  >
    <g-link
      class="company-logo-link block text-white font-bold text-2xl md:text-3xl hover:text-blue-300"
      to="/"
      aria-label="Back to home"
    >{{ $static.metadata.siteName }}</g-link>

    <nav id="nav" class="nav hidden md:flex">
      <a href="#" class="text-gray-200 hover:text-gray-600 mr-4" @click="toggleTheme">
