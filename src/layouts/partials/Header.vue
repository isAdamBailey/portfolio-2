<template>
  ...
  >
    <div class="flex w-full">
      <g-link
          class="company-logo-link block text-white font-bold text-2xl md:text-3xl hover:text-blue-300 w-3/4"
          to="/"
          aria-label="Back to home"
      >{{ $static.metadata.siteName }}</g-link>

      <a href="#" class="text-gray-200 hover:text-gray-600 w-1/4" @click="toggleTheme">
